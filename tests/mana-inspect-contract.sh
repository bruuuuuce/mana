...
grep -Fq 'existing optional `label`' "$root/contracts/mana-inspect/v1/SEMANTIC-CONTRACT.md"
grep -Fq 'Activity events may add `target`' "$root/contracts/mana-inspect/v1/SEMANTIC-CONTRACT.md"
