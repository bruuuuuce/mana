...
- Load and run only the PR readiness skills whose conditions in `AGENT.md` match
  the diff, validation report, test evidence, risk register, or handoff need.
