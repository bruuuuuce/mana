...
- Resolve and report the branch diff base. Prefer explicit PR target or user
...
- Load and run only the branch validation skills whose conditions in `AGENT.md`
  match the planning artifacts, branch diff, test evidence, or risk register.
