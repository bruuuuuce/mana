...
Typical debt includes legacy code entanglement, stale documentation, inconsistent naming conventions, missing regression suites, and undocumented operational rules.
