# Example Green Border Plan

Unit: mapper and validator paths. Integration: persistence and external failure. Contract: payload compatibility. Regression: TOKEN legacy flow.
