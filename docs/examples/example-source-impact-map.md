# Example Source Impact Map

Probably modify: mapper, validator, DTO, unit tests. Inspect first: controller, repository, integration flow. Do not touch unless approved: shared platform clients and unrelated legacy batch jobs.
