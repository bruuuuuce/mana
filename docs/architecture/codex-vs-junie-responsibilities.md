# Codex vs Junie Responsibilities

Codex handles repository-level planning, validation, documentation, PR readiness, and learning. Junie works inside the IDE on local implementation, test generation, local fixes, and developer feedback loops.
