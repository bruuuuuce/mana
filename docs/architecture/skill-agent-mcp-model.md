...
Skills are reusable analysis units. Agents compose skills into workflow phases. MCP provides governed access to enterprise systems with least privilege, audit, approval, and redaction.
