...
## Purpose
Plan unit, integration, contract, regression, and legacy characterization tests needed before and during implementation.
...
The owner role `Team Leader / QA` reviews blocker and warning findings. High-risk security, database, concurrency, or architecture findings require explicit approval before implementation or merge.

## Service Context Layer
Read `testing-policy.md`, `service-mission.md`, and `engineering-guards.md` to derive risk-driven tests.
...
```mermaid
flowchart TD
    Inputs[Required inputs] --> Skill[green-border-plan]
