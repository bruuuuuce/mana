...
version: 1.0.0
description: Generates the final development summary for review and team learning.
compatibility:
  - codex
  - junie
  - claude
...
## Purpose
Document assumptions, decisions, clarifications, implemented changes, tests, risks, unresolved items, and training notes for team alignment.
...
## Execution Logic
1. Aggregate planning and implementation artifacts.
2. Summarize actual changes without hiding deviations.
3. Attach verification evidence.
4. Highlight unresolved items for reviewers.
...
The owner role `Developer / Team Leader` reviews blocker and warning findings. High-risk security, database, concurrency, or architecture findings require explicit approval before implementation or merge.

## Service Context Layer
Reference relevant Service Context Layer files when explaining assumptions, decisions, and unresolved items.
...
```mermaid
flowchart TD
    Inputs[Required inputs] --> Skill[development-summary]
