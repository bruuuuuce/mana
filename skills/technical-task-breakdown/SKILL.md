...
## Purpose
Create actionable tasks for developers and Junie, each with scope, candidate files, dependencies, tests, risks, and definition of done.
...
```mermaid
flowchart TD
    Inputs[Required inputs] --> Skill[technical-task-breakdown]
...
## Example Output
```yaml
skill: technical-task-breakdown
status: warning
