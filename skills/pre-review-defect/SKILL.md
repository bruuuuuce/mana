---
name: pre-review-defect
version: 1.0.0
description: Detects likely defects before human review.
compatibility:
  - codex
  - junie
  - claude
...
## Purpose
Catch possible NPEs, bad error handling, missing validations, hidden side effects, suspicious mapping, and poor readability.
...
Read `engineering-guards.md`, `architecture.md`, and `testing-policy.md` before classifying pre-review defects.
...
```mermaid
flowchart TD
    Inputs[Required inputs] --> Skill[pre-review-defect]
